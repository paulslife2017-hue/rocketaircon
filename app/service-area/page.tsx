  ...
  return (
    <main id="top" className="area-page">
      ...
      <section className="area-hero">
        ...
        <aside aria-label="출장비 안내"><small>기본 출장비</small><b>30,000원</b><p>수리·부품·냉매 작업 비용은 별도이며 작업 전에 안내합니다.</p></aside>
      </section>
      ...
      <footer><div className="brand footer-brand"><span className="brand-mark">R</span><span>로켓에어컨</span></div><div><p>에어컨 수리 · 가스·냉매 점검 · 누수 · 실외기 점검</p><p>기본 출장비 30,000원 · 수리 및 부품 비용 별도</p><p>© 2026 ROCKET AIRCON. ALL RIGHTS RESERVED.</p></div></footer>
