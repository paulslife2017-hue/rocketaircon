const services = [
  ...
  { title:"에러코드·오류 표시", lead:"화면에 영문이나 숫자 코드가 표시될 때", symptoms:["CH·E 등 오류 문자가 나타남","표시등이 반복해서 깜빡임"], checks:["표시 코드와 기종","전원·센서·통신 계통","실외기 제어 상태"] },
];

const faqs = [
  ["오늘 바로 방문 가능한가요?", "오늘 방문을 우선으로 움직입니다. 지역, 접수 시간, 앞선 현장 작업을 확인한 뒤 가장 빠른 방문 시간을 안내드립니다."],
  ["출장비는 얼마인가요?", "기본 출장비는 30,000원입니다. 수리, 부품, 냉매 작업 비용은 별도이며 현장 점검 후 작업 전에 안내드립니다."],
    ...
    <main id="top">
      ...
      <section className="hero">
        <div className="hero-copy">
          ...
          <div className="hero-fee"><span>출장비 안내</span><b>기본 30,000원</b><small>수리·부품·냉매 비용 별도</small></div>
      ...
      <section className="contact" id="contact">
        <div><p>기본 출장비 30,000원</p><h2>지금 증상을 알려주세요.</h2><span>수리·부품 비용은 별도입니다. 에어컨 종류, 증상과 방문 지역을 말씀해 주세요.</span></div>
        <div className="contact-actions"><a href="tel:01080225800"><small>바로 전화 상담</small><b>010-8022-5800</b></a></div>
      </section>

      <footer><div className="brand footer-brand"><span className="brand-mark">R</span><span>로켓에어컨</span></div><div><p>에어컨 수리 · 냉매 점검 · 누수 · 소음·진동 점검</p><p>기본 출장비 30,000원 · 수리 및 부품 비용 별도</p><p className="footer-info">로켓에어컨 전용 사업자 정보 준비 중</p><p>© 2026 ROCKET AIRCON. ALL RIGHTS RESERVED.</p></div></footer>
