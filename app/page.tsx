...
const faqs = [
  ...
  ["출장비는 얼마인가요?", "기본 출장비는 30,000원입니다. 수리·부품·냉매 작업 비용은 별도입니다. 점검·진단 및 수리 비용은 작업 전 안내드립니다."],
  ...
  return (
    <main id="top">
      ...
      <section className="trust-row" aria-label="서비스 원칙">
        ...
        <div><span>03</span><b>출장비 3만원</b><p>점검·진단 및 수리 비용은 작업 전 안내드립니다.</p></div>
      ...
      <section className="contact" id="contact">
        <div><p>기본 출장비 30,000원</p><h2>지금 증상을 알려주세요.</h2><span>에어컨 종류, 증상과 방문 지역을 말씀해 주시면 상담이 빨라집니다.</span></div>
